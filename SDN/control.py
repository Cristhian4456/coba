...
def _handle_PacketIn(self, event):
        ...
        if udpp:
            ...
            if server_ip not in self.server_resources or self.server_resources[server_ip] != classified_resources:
                ...
                self.log.debug("Update K-NN Server %s", self.server_knn)
        ...
        if tcpp and (tcpp.dstport == 80 or tcpp.srcport == 80):
            ...
            if ipp.srcip in self.servers:
                ...
                msg = of.ofp_flow_mod(command=of.OFPFC_ADD, idle_timeout=FLOW_IDLE_TIMEOUT,hard_timeout=of.OFP_FLOW_PERMANENT, data=event.ofp,
